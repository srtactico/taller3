...
// Mantenemos los datos del mercado del usuario actual
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    // --- POPUP HISTORIAL DINÁMICO ARREGLADO (Nombres y Precios bilingües con Fallbacks) ---
                ...
                boxCompras.innerHTML = usuarioActual.historialCompras.map(function(compra) {
                    ...
                    if (compra.cartOriginal) {
                        itemsText = compra.cartOriginal.map(function(item) {
                            var n = item.nombre;
                            if (lang === 'en') {
                                n = item.nombreEn ? item.nombreEn : tacticalTranslator(item.nombre, 'en');
                            }
                            return "<span style='color:#fff;'>" + n + " (x" + item.cantidad + ")</span>";
                        }).join(", ");
                    } else {
                        // Fallback para pedidos muy antiguos en texto plano
                        var itms = compra.items || "";
                        if (lang === 'en') itms = tacticalTranslator(itms, 'en');
                        itemsText = "<span style='color:#fff;'>" + itms + "</span>"; 
                    }

                    // Calcular el precio total dinamicamente según idioma 
                    var totalMostrado = compra.total || "0€"; // Default legacy
                    if(compra.totalBase) {
                    ...
                    } else if (compra.totalMostradoOriginal) {
                        totalMostrado = compra.totalMostradoOriginal;
                    }
    ...
    var productosBase = [
        { id: 1, nombre: "Motor V8 Blindado", nombreEn: "Armored V8 Engine", tipo: "Mecanica Pesada", tipoEn: "Heavy Mechanics", precio: 4500, vendedor: "Tactical Reparations", imagen: "https://media.istockphoto.com/id/528918828/es/foto/motor-de-automoci%C3%B3n-3d-ilustraci%C3%B3n.jpg?s=612x612&w=0&k=20&c=o5ejIooVV10-5hFTbCv1l1IETRzSaHqupWhT-LRPbGc=", descripcion: "Motor de bloque grande optimizado para resistir impactos y mantener el rendimiento en condiciones extremas.", descripcionEn: "Big block engine optimized to withstand impacts and maintain performance under extreme conditions." },
        { id: 2, nombre: "Neumaticos Tacticos Off-Road", nombreEn: "Tactical Off-Road Tires", tipo: "Movilidad", tipoEn: "Mobility", precio: 800, vendedor: "Tactical Reparations", imagen: "https://www.muchoneumatico.com/blog/wp-content/uploads/2020/01/Neum%C3%A1ticos-4x4-extremos-MT-MS.jpg", descripcion: "Juego de 4 neumaticos de compuesto militar con diseño de banda de rodadura agresivo para barro y roca.", descripcionEn: "Set of 4 military compound tires with aggressive tread design for mud and rock." },
        { id: 3, nombre: "Kit de Suspension Reforzada", nombreEn: "Reinforced Suspension Kit", tipo: "Modificacion", tipoEn: "Upgrades", precio: 1200, vendedor: "Tactical Reparations", imagen: "https://www.tot4x4.com/2269-large_default/kit-de-suspension-reforzada-30mm-efs-diesel.jpg", descripcion: "Sistema de suspension de largo recorrido con amortiguadores de nitrogeno presurizado.", descripcionEn: "Long-travel suspension system with pressurized nitrogen shocks." },
        { id: 4, nombre: "Pintura Absorbe-Radar (Mate)", nombreEn: "Radar-Absorbent Paint (Matte)", tipo: "Estetica / Camuflaje", tipoEn: "Aesthetics / Camo", precio: 1500, vendedor: "Tactical Reparations", imagen: "https://montopinturas.com/public/Image/2023/7/502230.png", descripcion: "Recubrimiento ceramico avanzado con propiedades de absorcion de ondas de radar.", descripcionEn: "Advanced ceramic coating with radar wave absorption properties." },
        { id: 5, nombre: "Blindaje Ligero de Puertas", nombreEn: "Light Door Armor", tipo: "Defensa", tipoEn: "Defense", precio: 2100, vendedor: "Tactical Reparations", imagen: "https://images.unsplash.com/photo-1592853625601-bb9d23da12fc?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=400", descripcion: "Paneles de blindaje compuesto de nivel III+ para instalacion interna en puertas de vehiculos.", descripcionEn: "Level III+ composite armor panels for internal installation in vehicle doors." },
        { id: 6, nombre: "Luces LED de Alta Intensidad", nombreEn: "High-Intensity LED Lights", tipo: "Vision", tipoEn: "Vision", precio: 450, vendedor: "Tactical Reparations", imagen: "https://asxstore.com/cdn/shop/files/pop-up.png?v=1685366963&width=1080", descripcion: "Barra de luz LED de grado tactico con una salida combinada de 30,000 lumenes.", descripcionEn: "Tactical-grade LED light bar with a combined output of 30,000 lumens." },
        { id: 7, nombre: "Kit de Frenos Ceramicos", nombreEn: "Ceramic Brake Kit", tipo: "Mecanica Pesada", tipoEn: "Heavy Mechanics", precio: 1800, vendedor: "Tactical Reparations", imagen: "https://www.gt2i.es/175814-medium_default/vwr-kit-freno-stage-3-para-bastidor-mqb-mqb-evo-discos-380mm-carbono-ceramica-pinza-6-pistones.jpg", descripcion: "Discos de freno carbono-ceramicos perforados y ventilados. Resisten temperaturas extremas.", descripcionEn: "Carbon-ceramic drilled and vented brake discs. Withstand extreme temperatures." },
        { id: 8, nombre: "Asientos Tacticos Recaro", nombreEn: "Tactical Recaro Seats", tipo: "Estetica / Camuflaje", tipoEn: "Aesthetics / Camo", precio: 950, vendedor: "Tactical Reparations", imagen: "https://www.recarospain.com/wp-content/uploads/2018/06/recaro_sportster_cs_kule_schw_di_silber.jpg", descripcion: "Asientos deportivos tipo baquet con arneses de 5 puntos. Tejido ignifugo.", descripcionEn: "Bucket-style sports seats with 5-point harnesses. Fire-retardant fabric." },
        { id: 9, nombre: "Cristales Antibalas Nivel 4", nombreEn: "Level 4 Bulletproof Glass", tipo: "Defensa", tipoEn: "Defense", precio: 3200, vendedor: "Tactical Reparations", imagen: "https://s.alicdn.com/@sc04/kf/He66a4cd8b98b47358fa1093334495a72D/High-Quality-Bulletproof-Auto-Glass-Shield-Bullet-Resistance-Glass-Windshield-for-Car-Windows.jpg_300x300.jpg", descripcion: "Juego de cristales de policarbonato laminado ultragrueso. Capaces de detener impactos de calibres pesados.", descripcionEn: "Ultra-thick laminated polycarbonate glass set. Capable of stopping heavy calibers." }
    ];
        ...
        if(carrito.length > 0) {
            ...
            if(method === "tarjeta") {
                ...
                if(cNum.length < 16 || cDate.length < 5 || cCvc.length < 3) {
                    window.showAlert(currentLang === 'es' ? "Faltan datos obligatorios de la Tarjeta (16 digitos, Fecha MM/AA, 3 digitos CVC)." : "Missing exact Card data (16 digits, Date MM/YY, 3-digit CVC)."); return;
                }
        ...
        setTimeout(function() {
            if(typeof Swiper !== 'undefined') {
                swiper = new Swiper(".mySwiper", { 
                    ...
                    slidesPerView: "auto", 
                    loop: true, 
                    loopedSlides: galeriaActual.length, 
        ...
        var botReply = function(text) {
            ...
            if (currentLang === 'en') {
                if (check(["thank", "thx"])) {
                    ...
                    reply = "To buy items, browse our 'Buy/Sell' market, add products to your cart, and click the Cart button at the top right to checkout. Make sure your card is exactly 16 digits!";
                ...
                if (check(["gracia", "mersi"])) {
                    ...
                    reply = "Para comprar, " + name + ", busca el articulo en el mercado y pulsa 'Añadir'. Luego ve al 'Carrito' arriba a la derecha para pagar. La tarjeta debe tener 16 digitos exactos por motivos de seguridad del sistema.";
    ...
    if(document.getElementById("productos-db")) renderizarMercado();
    if(typeof window.renderizarMercadoFull === 'function') window.renderizarMercadoFull();
    if(document.getElementById("gallery-wrapper")) renderizarGaleria();
